...
const Login = () => {
  ...
  return (
    <main className="min-h-screen p-6 md:p-10 bg-primary items-center justify-center flex ">
      <div className="w-full max-w-md ">
        <h1 className="text-4xl text-bold mb-8 text-center text-gray-300">Login</h1>
        <form 
          onSubmit={handleSubmit}
          className="bg-secondary p-6 rounded-2xl border border-tertiary transition-all"
        >
          {error && (
            <ErrorAlert
          ...
          <div className="relative">
            <input
              ...
              className="w-full mb-4 bg-transparent text-gray-300 border border-tertiary py-3 px-4 
                rounded-xl outline-none focus:border-white transition-all duration-700 font-medium pr-10"
            />
            <button
              type="button"
